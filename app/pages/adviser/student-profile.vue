...
<template>
  <div class="mb-6">
    <h2 class="text-sm font-bold tracking-wide text-slate-900 uppercase">Student Profile</h2>
  </div>
  ...
  <div class="mb-3 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-slate-200 bg-white px-5 py-3 shadow-sm">
    <div class="flex items-center gap-4">
      ...
      <input
        v-model="studentId"
        type="text"
        class="w-64 rounded-md border border-slate-300 px-3 py-1.5 text-sm outline-none focus:border-up-maroon focus:ring-1 focus:ring-up-maroon"
      >
      <button
        type="button"
        class="rounded-full bg-up-maroon px-6 py-1.5 text-xs font-bold tracking-wide text-white transition hover:bg-up-maroon-dark"
        @click="searchStudent"
      >
        SEARCH
      </button>
    ...
    <div class="flex items-center gap-3">
      <button type="button" class="rounded-full bg-up-maroon px-6 py-1.5 text-xs font-bold tracking-wide text-white transition hover:bg-up-maroon-dark">
        PRINT
      </button>
      <button type="button" class="rounded-full bg-up-maroon px-6 py-1.5 text-xs font-bold tracking-wide text-white transition hover:bg-up-maroon-dark">
        EXPORT
  ...
  <div v-else class="rounded-xl border border-dashed border-slate-300 bg-slate-50 py-16 text-center">
    <p class="text-sm text-slate-500">Enter a student ID and click Search to view the academic profile.</p>
  </div>
</template>
