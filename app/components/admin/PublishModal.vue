    ...
    >
      <div class="relative w-full max-w-md overflow-hidden rounded-xl bg-white p-8 shadow-xl">
        ...
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-lg font-semibold text-slate-900">Publish Curriculum?</p>
          <p class="mt-2 text-sm text-slate-500">
            Are you sure you want to publish the <span class="font-semibold text-slate-700">{{ program || 'selected program' }}</span> curriculum for <span class="font-semibold text-slate-700">{{ curriculumYear || 'the selected year' }}</span>?
            <br><br>
            Once published, it will be visible to all advisers, students, and OUR staff.
          </p>
